import { box, line, Point, point, Segment, segment, vector } from "@flatten-js/core"
...
const sketch: SketchFactory = ({ random, params }) => {
  ...
  function drawLines(rotation: number) {
    ...
    const bbox = box(-params.width / 2, -params.height / 2, params.width / 2, params.height / 2) //TODO: Refactor to SketchParams
    let factor = 0
