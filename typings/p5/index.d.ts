...
/// <reference path="src/SoundFile.d.ts" />
/// <reference path="src/Amplitude.d.ts" />
/// <reference path="src/FFT.d.ts" />
/// <reference path="src/Oscillator.d.ts" />
/// <reference path="src/Envelope.d.ts" />
/// <reference path="src/Noise.d.ts" />
/// <reference path="src/AudioIn.d.ts" />
/// <reference path="src/Panner3D.d.ts" />
/// <reference path="src/Delay.d.ts" />
/// <reference path="src/Reverb.d.ts" />
/// <reference path="src/Gain.d.ts" />
/// <reference path="src/Biquad.d.ts" />
/// <reference path="src/Panner.d.ts" />
/// <reference path="src/PitchShifter.d.ts" />
